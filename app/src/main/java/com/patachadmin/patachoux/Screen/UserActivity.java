...
public class UserActivity extends AppCompatActivity {
    ...
    public class ArrayAdapter extends RecyclerView.Adapter<ArrayAdapter.ImageViewHoler> {
        ...
        public ArrayAdapter.ImageViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(UserActivity.this).inflate(R.layout.item_suplier,parent,false);
        ...
        currentUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    dRef=  FirebaseDatabase.getInstance().getReference("User").child(suplierArrayList.get(position).getName());
                    dRef.removeValue();
                    getSuplierData();
                }
            }
